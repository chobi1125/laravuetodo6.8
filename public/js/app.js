...
/* harmony default export */ __webpack_exports__["default"] = ({
  data: function data() {
    return {
      ...
      todos: "" // ToDoリストを受取(配列かつオブジェクトで受け取ってる。)
  ...
  methods: {
    addTodo: function addTodo() {
      ...
      var data = {
        todo: this.todo_form // insertされる内容。カラムに合わせる。

      };
      axios.post('/api', data).then(function () {
        _this.getTodoList();
      });
    },
    deleteTodo: function deleteTodo(id) {
      ...
      axios["delete"]("/api/" + id, data).then(function () {
        _this2.getTodoList();
      });
    },
    updateTodo: function updateTodo(id) {
      ...
      var data = {
        ...
        todo: this.todos.filter(function (value) {
          return value.id === id;
        })[0].todo // 「filter」は配列オブジェクトから条件に一致した要素だけを抽出する。()内は値、数値インデックスなど指定可能。todos配列から.idで要素のidを取得。一致する項目を[0]で1つのみ取得。
        // コールバックとは「引数として渡される関数」

      };
      axios.put("/api/" + id, data).then(function () {
        _this3.getTodoList();
...
var render = function() {
  ...
  return _c(
    ...
    [
      ...
      _vm._v(" "),
      _c("button", { attrs: { type: "button" }, on: { click: _vm.addTodo } }, [
        _vm._v("追加")
      ]),
      _vm._v(" "),
...
Vue.component('example-component', __webpack_require__(/*! ./ExampleComponent.vue */ "./resources/js/ExampleComponent.vue")["default"]);
var app = new Vue({
  el: '#app'
});
...
__webpack_require__(/*! C:\xampp\htdocs\memo_noauth6.8\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\xampp\htdocs\memo_noauth6.8\resources\sass\app.scss */"./resources/sass/app.scss");
